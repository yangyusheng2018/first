...
document.writeln("<td><input name=\'email\' type=\'text\' value=\'Such as: chat@indh.net\' style=\'color: rgb(153, 153, 153);\' maxlength=\'50\' onblur=\"if(value==\'\'){value=\'Such as: chat@indh.net\';this.style.color=\'#999\';};\" onfocus=\"if(value==\'Such as: chat@indh.net\'){value=\'\';this.style.color=\'#000\';};\" size=\'25\'></td>");
document.writeln("</tr>");
document.writeln("<tr>");
...
function CheckfootInput() {
    ...
    if (document.form.email.value == '' || document.form.email.value == 'Such as: chat@indh.net' || !is_email(document.form.email.value)) {
