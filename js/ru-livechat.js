...
document.writeln("LR_showInviteDiv(\"Добро пожаловать на наш сайт\",\"Это наш интернет-сервис. Если у вас есть какие-либо вопросы, пожалуйста, примите этот диалог. ^_^&nbsp;<br/>Вы также можете использовать следующие способы:<br/>Email:<b> chat@indh.net</b>\");");
