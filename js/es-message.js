...
document.writeln("<td><input name=\"email\" type=\"text\" class=\"input-xlarge\" style=\"color: rgb(153, 153, 153);\" onfocus=\"if(value==\'Como: chat@indh.net\'){value=\'\';this.style.color=\'#000\';};\" onblur=\"if(value==\'\'){value=\'Como: chat@indh.net\';this.style.color=\'#999\';};\" value=\"Como: chat@indh.net\" size=\"25\" maxlength=\"50\" /></td>");
document.writeln("</tr>");
document.writeln("<tr>");
document.writeln("<td><!-- Text input-->");
...
if(document.form.email.value==''||document.form.email.value=='Como: chat@indh.net'||!is_email(document.form.email.value)){
