document.writeln("<style type=\"text/css\">.form-horizontal table{border-collapse: collapse; width:100% !important;}");
...
document.writeln("<tr>");
document.writeln("<td><label class=\'control-label\'><b>*</b>محصولات:</label></td>");
document.writeln("<td><select name=\'products\' class=\'input-xlarge\'>");
document.writeln("<option selected=\'selected\' value=\'\' style=\'color:#ff0000; font-weight:bold;\'>لطفا انتخاب کنید!</option>");
document.writeln("<option value=\'Mobile crushing plant\'>سنگ شکن موبایل</option>");
document.writeln("<option value=\'LM Vertical Grinding Mill\'>میل عمودی</option>");
document.writeln("<option value=\'Jaw Crusher\'>سنگ شکن فکی</option>");
document.writeln("<option value=\'Cone Crusher\'>سنگ شکن مخروطی</option>");
document.writeln("<option value=\'MTW European Grinding Machine\'>MTW دستگاه آسیاب اروپایی</option>");
document.writeln("<option value=\'Ultrafine Mill\'>میلز فوق العاده</option>");
document.writeln("<option value=\'Impact Crusher\'>سنگ شکن ضربه ای</option>");
document.writeln("<option value=\'VSI Crusher\'>سنگ شکن VSI</option>");
document.writeln("<option value=\'Hydraulic Cylinder Cone Crusher\'>سنگ شکن مخروطی هیدرولیک</option>");
document.writeln("<option value=\'Sand Washing Machine\'>ماشین لباسشویی شن و ماسه</option>");
document.writeln("<option value=\'Vibrating Screen\'>صفحه لرزان</option>");
document.writeln("<option value=\'Vibrating Feeder\'>فیدر ارتعاشی</option>");
document.writeln("<option value=\'Belt Conveyor\'>تسمه نقاله</option>");
document.writeln("<option value=\'Stone processing production line\'>خط تولید پردازش سنگ</option>");
document.writeln("<option value=\'Industrial milling production line\'>خط تولید میلز صنعتی</option>");
document.writeln("<option value=\'Beneficiation Production Line\'>خط تولید بهره وری</option>");
document.writeln("<option value=\'Not Sure\' style=\'color:#ff0000; font-weight:bold;\'>مطمئن نیستم !</option>");
document.writeln("</select></td>");
document.writeln("</tr>");
document.writeln("<tr>");
document.writeln("<td valign=\'top\'><label class=\'control-label\'>مواد:</label></td>");
...
document.writeln("</tr>");
document.writeln("<tr>");
document.writeln("<td valign=\'top\'><label class=\'control-label\'>ظرفیت:</label></td>");
...
document.writeln("<label class=\'control-label\' for=\'address\'>استفاده از محل:</label></td>");
...
document.writeln("<tr>");
document.writeln("<td><!-- Text input-->");
document.writeln("<label class=\'control-label\' for=\'name\'><b>*</b>نام:</label></td>");
...
document.writeln("<tr>");
document.writeln("<td><!-- Text input-->");
document.writeln("<label class=\'control-label\' for=\'phone\'>تلفن:</label></td>");
...
document.writeln("<tr>");
document.writeln("<td><!-- Text input-->");
document.writeln("<label class=\'control-label\' for=\'company\'>نام شرکت:</label></td>");
...
document.writeln("<label class=\'control-label\'>پیام:<span class=\'red\'>*</span></label></td>");
