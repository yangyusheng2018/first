...
// 商务通
$livechat=array(
	'sbm'=>'<script language="javascript" src="http://pkt.zoosnet.net/JS/LsJS.aspx?siteid=PKT21646611&float=1&lng=en"></script>',
	'zenith'=>'<script language="javascript" src="http://pkt.zoosnet.net/JS/LsJS.aspx?siteid=PKT56764896&float=1&lng=en"></script>',
...
$home = $config['/'][1];
$post['title']='homepage';
$banner['sbm']=array('/images/banner_s_1.jpg','/images/banner_s_2.jpg','/images/banner_s_3.jpg','/images/banner_s_4.jpg','/images/banner_s_5.jpg');
$banner['zenith']=array('/images/banner_z_1.jpg','/images/banner_z_2.jpg','/images/banner_z_3.jpg','/images/banner_z_4.jpg','/images/banner_z_5.jpg','/images/banner_z_6.jpg');
...
if($uri=='/contact-us.html'||$uri=='/contact.html'){
	...
	$post['content']="<h3>Head office address</h3><p>No.416 Jianye Road, South Jinqiao Area, Pudong, Shanghai, China</p><p> Zip: 201201</p>";
	if(file_exists($dir.'/themes/'.$themedir.'/page.php')) include($dir.'/themes/'.$themedir.'/page.php'); 
...
if(strstr($file,'-')){
	...
	$post['title']=str_replace('SBM',$company,$post['title']);
	$post['description']=str_replace('SBM',$company,$post['description']);
	$post['content']=str_replace('SBM',$company,$post['content']);
